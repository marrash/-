...
class G10Tester(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.PANNEL_HEIGHT_RATIO = (0.45, 0.7) # 老虎機面板範圍 (以百分比表示艱鉅)
...
if __name__ == '__main__':
    ...
    # testunit.addTest(G9Tester('case_enable_slot_cheat_table'))
    ...
    BeautifulReport(testunit).report(
        ...
        report_dir = config.REPORT_GEN_DIR
    )
